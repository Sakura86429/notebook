        ...
        <div class="col-md-3">
            ...
            <div class="data_list">
                ...
                <div class="userimg">
                    ...
                    <%--注意此处，还需要userHead函数中获取到的参数imageName，再El表达式从session中取user.head--%>
                ...
                <div>
                    <ul id="typeUl" class="nav nav-pills nav-stacked">
                        <c:forEach items="${typeInfo}" var="item">
                            <li id="li_${typeId}">
                                <%--为什么传id：因为方便查询，id是唯一的--%>
                                <a href="index?actionName=searchType&typeId=${item.typeId}">${item.groupName}
